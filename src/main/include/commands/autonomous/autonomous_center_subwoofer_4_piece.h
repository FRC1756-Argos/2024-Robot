...
class AutonomousCenterSubwoofer4Piece
    : public frc2::CommandHelper<frc2::Command, AutonomousCenterSubwoofer4Piece>
    , public AutonomousCommand {
 public:
  AutonomousCenterSubwoofer4Piece(IntakeSubsystem& intake,
