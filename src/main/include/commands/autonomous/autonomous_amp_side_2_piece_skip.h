...
class AutonomousAmpSideSubwoofer2PieceSkip
    : public frc2::CommandHelper<frc2::Command, AutonomousAmpSideSubwoofer2PieceSkip>
    , public AutonomousCommand {
 public:
  AutonomousAmpSideSubwoofer2PieceSkip(IntakeSubsystem& intake,
