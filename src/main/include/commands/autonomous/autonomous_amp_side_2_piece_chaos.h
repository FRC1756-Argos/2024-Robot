...
class AutonomousAmpSideSubwoofer2PieceChaos
    : public frc2::CommandHelper<frc2::Command, AutonomousAmpSideSubwoofer2PieceChaos>
    , public AutonomousCommand {
 public:
  AutonomousAmpSideSubwoofer2PieceChaos(IntakeSubsystem& intake,
