...
class AutonomousSourceSideSubwoofer4Piece
    : public frc2::CommandHelper<frc2::Command, AutonomousSourceSideSubwoofer4Piece>
    , public AutonomousCommand {
 public:
  AutonomousSourceSideSubwoofer4Piece(IntakeSubsystem& intake,
