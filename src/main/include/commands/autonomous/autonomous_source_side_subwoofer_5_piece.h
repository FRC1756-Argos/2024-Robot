...
class AutonomousSourceSideSubwoofer5Piece
    : public frc2::CommandHelper<frc2::Command, AutonomousSourceSideSubwoofer5Piece>
    , public AutonomousCommand {
 public:
  AutonomousSourceSideSubwoofer5Piece(IntakeSubsystem& intake,
