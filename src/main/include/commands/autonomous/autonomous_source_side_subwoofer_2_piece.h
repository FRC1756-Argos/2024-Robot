...
class AutonomousSourceSideSubwoofer2Piece
    : public frc2::CommandHelper<frc2::Command, AutonomousSourceSideSubwoofer2Piece>
    , public AutonomousCommand {
 public:
  AutonomousSourceSideSubwoofer2Piece(IntakeSubsystem& intake,
