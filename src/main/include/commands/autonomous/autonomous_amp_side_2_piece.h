...
class AutonomousAmpSideSubwoofer2Piece
    : public frc2::CommandHelper<frc2::Command, AutonomousAmpSideSubwoofer2Piece>
    , public AutonomousCommand {
 public:
  AutonomousAmpSideSubwoofer2Piece(IntakeSubsystem& intake,
