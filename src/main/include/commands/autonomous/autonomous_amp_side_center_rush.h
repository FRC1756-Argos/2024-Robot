...
class AutonomousAmpSideSubwooferCenterRush
    : public frc2::CommandHelper<frc2::Command, AutonomousAmpSideSubwooferCenterRush>
    , public AutonomousCommand {
 public:
  AutonomousAmpSideSubwooferCenterRush(IntakeSubsystem& intake,
