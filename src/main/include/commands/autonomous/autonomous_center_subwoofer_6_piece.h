...
class AutonomousCenterSubwoofer6Piece
    : public frc2::CommandHelper<frc2::Command, AutonomousCenterSubwoofer6Piece>
    , public AutonomousCommand {
 public:
  AutonomousCenterSubwoofer6Piece(IntakeSubsystem& intake,
