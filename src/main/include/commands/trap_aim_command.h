 ...
 */
class TrapAimCommand : public frc2::CommandHelper<frc2::Command, TrapAimCommand> {
 public:
  TrapAimCommand(SwerveDriveSubsystem* swerveDrive,
                 VisionSubsystem* vision,
                 argos_lib::SwappableControllersSubsystem* controllers,
                 SimpleLedSubsystem* leds,
                 bool endWhenAligned = false);
