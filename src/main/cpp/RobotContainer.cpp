...
RobotContainer::RobotContainer()
    ...
    , m_visionSubSystem(m_instance, &m_swerveDrive, &m_ShooterSubSystem)
    ...
    , m_autoAmpSideSubwoofer2Piece{m_intakeSubsystem,
                                   ...
                                   m_controllers,
                                   m_ledSubSystem}
    , m_autoAmpSideSubwoofer2PieceSkip{m_intakeSubsystem,
                                       m_ShooterSubSystem,
                                       m_elevatorSubsystem,
                                       m_swerveDrive,
                                       m_visionSubSystem,
                                       m_controllers,
                                       m_ledSubSystem}
    , m_autoAmpSideSubwoofer2PieceChaos{m_intakeSubsystem,
                                        m_ShooterSubSystem,
                                        m_elevatorSubsystem,
                                        m_swerveDrive,
                                        m_visionSubSystem,
