...
AutonomousSourceSideSubwoofer3PieceSteal::AutonomousSourceSideSubwoofer3PieceSteal(
    ...
    , m_SeqCommands{frc2::SequentialCommandGroup{
          ...
          frc2::ParallelCommandGroup{
              DriveChoreo{m_Swerve, "Source_Side_3_Mid.1", true},
          ...
          ShooterCommand{&m_Shooter, true},
          frc2::ParallelCommandGroup{
              DriveChoreo{m_Swerve, "Source_Side_3_Mid.2", false},
              IntakeCommand{&m_Intake, &m_Shooter, &m_Elevator, &controllers, &leds, true, 1.5_s}},
          AutoAimCommand{&swerve, &shooter, &elevator, &vision, &controllers, &leds, true},
          ShooterCommand{&m_Shooter, true},
          frc2::ParallelCommandGroup{
              DriveChoreo{m_Swerve, "Source_Side_3_Mid.3", false},
              IntakeCommand{&m_Intake, &m_Shooter, &m_Elevator, &controllers, &leds, true, 1.5_s}}}} {}
...
std::string AutonomousSourceSideSubwoofer3PieceSteal::GetName() const {
  return "12. Source Side Subwoofer 3 Piece Steal";
}
