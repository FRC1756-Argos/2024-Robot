...
AutonomousCenterSubwoofer4Piece::AutonomousCenterSubwoofer4Piece(IntakeSubsystem& intake,
    ...
    , m_SeqCommands{frc2::SequentialCommandGroup{
          ...
          frc2::ParallelCommandGroup{
              DriveChoreo{m_Swerve, "Center_Subwoofer_Multi.1", true},  ///< @todo Change name to match Choreo
          ...
          ShooterCommand{&m_Shooter, true},
          frc2::ParallelCommandGroup{DriveChoreo{m_Swerve, "Center_Subwoofer_Multi.2", false},
                                     IntakeCommand{&m_Intake, &m_Shooter, &m_Elevator, &controllers, &leds, true}},
          AutoAimCommand{&swerve, &shooter, &elevator, &vision, &controllers, &leds, true},
          ShooterCommand{&m_Shooter, true},
          frc2::ParallelCommandGroup{DriveChoreo{m_Swerve, "Center_Subwoofer_Multi.3", false},
                                     IntakeCommand{&m_Intake, &m_Shooter, &m_Elevator, &controllers, &leds, true}},
          AutoAimCommand{&swerve, &shooter, &elevator, &vision, &controllers, &leds, true},
          ShooterCommand{&m_Shooter, true}}} {}
...
std::string AutonomousCenterSubwoofer4Piece::GetName() const {
  return "08. Center Subwoofer 4 Piece";
}
